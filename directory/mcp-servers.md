...
- [SOLx402 MCP](https://github.com/0xMetatime/solx402-mcp-server) — Interact with x402 on Solana. Discover/consume services, manage USDC, query protocol docs.
...
- [ZKProofport MCP](https://github.com/zkproofport/proofport-ai) — Zero-knowledge identity proof generation. Coinbase KYC, Country, Google OIDC proofs without revealing personal data. AWS Nitro Enclave TEE proving. NPM: `@zkproofport-ai/mcp`. Won 1st place at The Synthesis Hackathon (April 2026).
