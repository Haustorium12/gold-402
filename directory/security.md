...
- [PaySentry](https://github.com/mkmkkkkk/paysentry) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/mkmkkkkk/paysentry) — Control plane for AI agent payments. Spending limits, circuit breakers, anomaly detection, audit trails. npm: `@paysentry/x402`.
- [x402 Notary](https://github.com/x402notary/notary) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/x402notary/notary) — Enterprise-grade audit and compliance platform. Full visibility into agent spending, policy enforcement, cryptographic audit trails.
...
- [Decision Anchor](https://api.decision-anchor.com) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/zse4321/decision-anchor-sdk) — External accountability proof before x402 payment execution. Records what was authorized, when, and at what scope. Non-judgmental.

---

## Agent Trust & Reputation

- [Revettr](https://revettr.com) [![A2A Ready](https://img.shields.io/badge/A2A-ready-purple?style=flat-square)](https://revettr.com) — Counterparty risk scoring for x402 agentic commerce. Scores wallet addresses, domains, IPs, and companies 0-100 for payment safety.
- [MoltGuard](https://api.moltrust.ch/guard/) [![ERC-8004](https://img.shields.io/badge/ERC--8004-registered-orange?style=flat-square)](https://api.moltrust.ch) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/moltrust/moltguard) — Agent trust scoring (0-100), Sybil detection with funding cluster analysis, Polymarket integrity, Ed25519 Verifiable Credentials. 7 MCP tools. $0.005-$0.05 USDC on Base.
- [DJD AgentScore](https://github.com/djd-agent-score/djd-agent-score) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/djd-agent-score/djd-agent-score) — On-chain reputation scoring for AI agent wallets. 0-100 trust score across 5 dimensions (identity, behavior, reliability, viability, capability) from x402 settlement history on Base. Free tier.
...
- [CYBERA Compliance API](https://compliance-api-ruddy.vercel.app) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/tedddb-ai/compliance-api) [![MiCA](https://img.shields.io/badge/MiCA-aware-blue?style=flat-square)](https://compliance-api-ruddy.vercel.app) — VASP address identification (20,468 addresses, 29 chains), risk scoring, sanctions/mixer screening. $0.01 USDC on Base.
- [SENTINEL](https://mru-oracle.com) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/INJprotocol/mauritius-oracle-) — AML/CFT compliance intelligence. 77K+ sanctions entities (OFAC, UN, EU, PEP, Interpol, World Bank, crypto watchlists), 159-country jurisdiction risk scoring. MCP server at `/mcp`. $0.001-$0.015 USDC on Base.
