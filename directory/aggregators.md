...
- [402Signal](https://402signal.com/route) — Fail-closed live-endpoint x402 router. POST /route returns a currently-alive x402 URL or an honest miss. $0.01 USDC on Base, Solana, and Algorand. Example: `POST /route {"need":"weather"}`. ([OpenAPI](https://402signal.com/openapi.json)) ([MCP](https://402signal.com/mcp.json)) ([Manifest](https://402signal.com/.well-known/x402))
