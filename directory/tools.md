...
- [x402-proxy](https://github.com/cascade-protocol/x402-proxy) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/cascade-protocol/x402-proxy) [![Multi-Chain](https://img.shields.io/badge/Multi--Chain-2+-blue?style=flat-square)](https://github.com/cascade-protocol/x402-proxy) — `curl` for x402 paid APIs. Auto-pays HTTP 402 with USDC on Base and Solana. MCP stdio proxy for AI agents. `npx x402-proxy`. ([npm](https://www.npmjs.com/package/x402-proxy))
- [ClawRouter](https://github.com/BlockRunAI/ClawRouter) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/BlockRunAI/ClawRouter) [![Multi-Chain](https://img.shields.io/badge/Multi--Chain-2+-blue?style=flat-square)](https://github.com/BlockRunAI/ClawRouter) — Agent-native LLM router. 41+ models, <1ms routing, USDC payments on Base and Solana via x402. "Payment IS authentication." Part of the OpenClaw ecosystem.
- [key0](https://github.com/key0ai/key0) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/key0ai/key0) — Commercial gateway for AI agents. Discover, pay for, and access APIs autonomously via x402. Exposes `/discover`, `/x402/access`, `/.well-known/agent.json`, `/.well-known/mcp.json`, `/llms.txt`.
...
- [PaySentry](https://github.com/mkmkkkkk/paysentry) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/mkmkkkkk/paysentry) — Control plane for AI agent payments. Spending limits, circuit breakers, anomaly detection, audit trails for x402. npm: `@paysentry/x402`.
- [x402 Notary](https://github.com/x402notary/notary) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/x402notary/notary) — Enterprise-grade audit and compliance platform for x402. Full visibility into agent spending, policy enforcement, cryptographic audit trails.
- [Decision Anchor](https://api.decision-anchor.com) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/zse4321/decision-anchor-sdk) — External accountability proof for agent payments and delegation. Records what was authorized, when, at what scope — before x402 payment execution.
...
- [AgentIndex](https://agentndx-production.up.railway.app) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/agentndx/agentndx) — Unified search across 15,000+ MCP services, A2A agents, and x402 APIs from 5 registries (Smithery, official MCP, GitHub, Bazaar, A2A). x402 paid search ($0.005), analyze ($0.05), trending ($0.10).
- [Cinderwright Discovery Hub](https://api.ideafactorylab.org) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/cinderwright-ai/cinderwright-api) — x402 service search engine. 152+ services across 9 categories with daily crawling and health checks. Paid search, free submission, free stats. Built by a production autonomous AI agent.
...
- [x402search MCP](https://github.com/x402-index/x402search-mcp) [![Open Source](https://img.shields.io/badge/Open_Source-green?style=flat-square)](https://github.com/x402-index/x402search-mcp) — Search 14,000+ x402-enabled HTTP APIs. Also live as ACP agent on Virtuals Protocol (ID 22531). ([npm](https://www.npmjs.com/package/x402search-mcp)) ([PyPI](https://pypi.org/project/x402search-mcp/))
